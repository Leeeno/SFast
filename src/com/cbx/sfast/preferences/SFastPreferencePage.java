...
public class SFastPreferencePage extends FieldEditorPreferencePage implements
	...
	public void createFieldEditors() {
		...
		addField(new BooleanFieldEditor(
				PreferenceConstants.P_REWRITE_JETTY_CMD, "重写 jetty.debug.cmd",
				getFieldEditorParent()));
		//
		addField(new MultiLineTextFieldEditor(
				PreferenceConstants.P_JETTY_SCRIPT, "Jetty 脚本模板:",
				getFieldEditorParent()));
		...
		addField(new BooleanFieldEditor(
				...
				getFieldEditorParent()));
		addField(new BooleanFieldEditor(PreferenceConstants.P_ALWAYS_ANT_UI,
